...
public class TCP implements IoLoop.Handler {
    ...
    public SocketChannel getBlockSocketChannel() {
        try {
            ...
            Log.d(TAG, "configure socket exception:" + e);
            return null;
        }
    }
    ...
    public void handleEvent(SelectionKey key) {
        Log.d(TAG, "socket readyops:" + key.readyOps());
    ...
    private void handleWrite() {
        ...
        try {
            ...
            Log.d(TAG, "write data left:" + nleft);
            if (nleft > 0) {
    ...
    public void writeData(byte[] bytes) {
        ...
        Log.d(TAG, "write data left:" + data.length);
    }
